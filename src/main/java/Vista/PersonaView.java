...
public class PersonaView extends javax.swing.JInternalFrame {
    ArrayList<PersonasModelo> ListaPersona =new ArrayList<>();
    ...
    public void SetDatos(){
     ...
     int cont=1;
        ...
        for (PersonasModelo datos : ListaPersona) {
            informacion[0]=cont;
    ...
    private void BttAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BttAgregarActionPerformed
        // TODO add your handling code here:
        //PersonasModelo pm=new PersonasModelo(txtNombre.getText(), Integer.parseInt(txtCedula.getText()), 
